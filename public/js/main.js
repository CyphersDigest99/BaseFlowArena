...
function hideBeatPlayerBar() {
    const bar = document.getElementById('beat-player-bar');
    if (bar) bar.style.display = 'none';
}
function showBeatPlayerBar() {
    const bar = document.getElementById('beat-player-bar');
    if (bar) bar.style.display = '';
}

// Call this on page load (after DOMContentLoaded or equivalent)
document.addEventListener('DOMContentLoaded', () => {
    checkBeatsAndInitPlayer();
    initializeApp(); // Call initializeApp after beats are checked
});